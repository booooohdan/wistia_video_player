...
class WistiaPlayerOptions {
  ...
  String toString() {
    List<String> values = [
      ...
      'fitStrategy=${fitStrategy.name}',
      'fullscreenButton=$fullscreenButton',
      'fullscreenOnRotateToLandscape=$fullscreenOnRotateToLandscape',
      'googleAnalytics=$googleAnalytics',
      'playbackRateControl=$playbackRateControl',
      'playbar=$playbar',
      'playButton=$playButton',
      if (playerColor != null) 'playerColor=$playerColor',
      if (playlistLinks != null) 'playlistLinks=$playlistLinks',
      ...
      if (thumbnailAltText != null) 'thumbnailAltText=$thumbnailAltText',
      'videoFoam=$videoFoam',
      'volume=$volume',
